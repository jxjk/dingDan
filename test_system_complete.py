...
def test_file_monitor():
    ...
    try:
        ...
        config_manager = get_config_manager()
        file_monitor = FileMonitorManager(config_manager.config)
        
        # 检查监控文件是否存在
        onoff_file = config_manager.config['file_monitoring']['onoff_file']
        macro_file = config_manager.config['file_monitoring']['macro_file']
